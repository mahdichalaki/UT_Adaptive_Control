...
for i = 2:(length(R_estimated_toPlot(1,:))) % first parameter of R is 1
    subplot(1,2,i-1);
    title_text = "R_%d";
    plot(1:num_samples, R_estimated_toPlot(:,i)./R_estimated_toPlot(:,1),'b', 'linewidth',1) 
%     hold on;
...
for i = 1:(length(S_estimated_toPlot(1,:))) % first parameter of R is 1
    subplot(2,2,i);
    title_text = "S_%d";
    plot(1:num_samples, S_estimated_toPlot(:,i)./R_estimated_toPlot(:,1),'b', 'linewidth',1) 
%     hold on;
...
for i = 1:(length(T_toPlot(1,:))) % first parameter of R is 1
    subplot(2,2,i);
    title_text = "T_%d";
    plot(1:num_samples, T_toPlot(:,i)./R_estimated_toPlot(:,1),'b', 'linewidth',1) 
%     hold on;
